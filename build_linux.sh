...
.build-venv/bin/python -m PyInstaller --clean --noconfirm --onefile --name UKNewsScraper run_scraper.py
.build-venv/bin/python -m PyInstaller --clean --noconfirm --onefile --name UKNewsScraper_protected run_scraper_protected.py

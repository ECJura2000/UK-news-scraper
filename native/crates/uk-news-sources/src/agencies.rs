...
pub fn agencies() -> Vec<Agency> {
    vec![
    gov("科學、創新和技術部","Department for Science, Innovation and Technology","DSIT","department-for-science-innovation-and-technology",&["AI","資料治理/隱私/數位身份","網路安全/資安","半導體/量子技術"]),
    gov("人工智慧安全機構","AI Safety Institute","AISI","ai-safety-institute",&["AI"]),
    ...
    gov("政府數位服務團隊","Government Digital Service","GDS","government-digital-service",&["資料治理/隱私/數位身份"]),
    ...
    gov("英國內閣辦公室","Cabinet Office","Cabinet Office","cabinet-office",&["網路安全/資安"]),
    ...
    gov("商業及貿易部","Department for Business and Trade","DBT","department-for-business-and-trade",&["半導體/量子技術"]),
...
mod tests {
    ...
    #[test]
    fn registry_contains_all_thirteen_official_agencies() {
        let values = agencies();
